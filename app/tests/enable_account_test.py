...
account_url: str = '/api/v1/accounts/enable/'
...
@pytest.mark.anyio
async def test_enable_account_failed_invalid_access_token(client: httpx.AsyncClient):
    # Header
    test_header = {
...
@pytest.mark.anyio
async def test_enable_account_failed_not_admin(client: httpx.AsyncClient):
...
@pytest.mark.anyio
async def test_enable_account_failed_invalid_account_id(client: httpx.AsyncClient):
...
@pytest.mark.anyio
async def test_enable_account_failed_account_enabled(client: httpx.AsyncClient):
